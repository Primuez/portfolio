...
function ScrollProgressBar() {
  ...
  return (
    <motion.div
      ...
      className="fixed top-0 left-0 right-0 h-[1px] z-[60] bg-gradient-to-r from-cyan via-cyan/60 to-amber/40 pointer-events-none gpu-accelerated"
    />
  );
}
...
function HomeClientShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="fixed inset-0 z-[1] bg-blueprint opacity-15 animate-grid pointer-events-none gpu-accelerated"></div>
      ...
      {/* Main page content (Rendered via Server Component composition) */}
      {children}
