...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section id="hero" className="min-h-[100dvh] flex flex-col justify-center pt-20 md:pt-20 pb-8 md:pb-0 relative overflow-hidden -mx-[17px] sm:-mx-[25px] md:-mx-[50px] px-4 sm:px-6 md:px-12">
