    ...
    <div ref={containerRef} style={{ height: `${WHY_ITEMS.length * 100}vh` }} className="relative -mx-4 sm:-mx-6 md:-mx-12">
      ...
      >
        <div className="relative w-full h-full">
          ...
          {/* Toggle — top-left, always visible, never covered by slide content */}
          <div className="absolute top-6 left-6 md:left-10 z-30 flex bg-[#05060a]/90 border border-white/10 p-1 rounded-xl font-mono text-[9px] tracking-widest uppercase shadow-[0_4px_20px_rgba(0,0,0,0.5)]">
            <button
    ...
    <div ref={containerRef} style={{ height: `${WHY_ITEMS.length * 70}vh` }} className="relative -mx-4 sm:-mx-6 md:-mx-12">
      ...
      >
        <div className="relative w-full h-full">
          ...
          {/* Toggle — top-left on mobile, never covered */}
          <div className="absolute top-4 left-4 z-30 flex bg-[#05060a]/90 border border-white/10 p-0.5 rounded-xl font-mono text-[8px] tracking-widest uppercase shadow-[0_4px_20px_rgba(0,0,0,0.5)]">
            <button
              onClick={() => setDetailMode('brief')}
